// Inline SVG icons — stroke-based, 24x24 default
const Icon = ({ d, size = 22, fill = "none", stroke = "currentColor", sw = 1.8, children, style }) => (
...
const IconLocate = (p) => <Icon {...p}><line x1="2" y1="12" x2="5" y2="12"/><line x1="19" y1="12" x2="22" y2="12"/><line x1="12" y1="2" x2="12" y2="5"/><line x1="12" y1="19" x2="12" y2="22"/><circle cx="12" cy="12" r="7"/><circle cx="12" cy="12" r="2" fill="currentColor"/></Icon>;
...
const IconLeaf = (p) => <Icon {...p}><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19.2 2.96c1.4 9.3-3.6 15.04-8.2 17.04Z"/><path d="M2 22 9.8 6.1"/></Icon>;
...
const IconLoginArrow = (p) => <Icon {...p} sw={2}><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></Icon>;
...
Object.assign(window, { Icon, IconBell, IconChat, IconLogout, IconSearch, IconFlame, IconLocate, IconCompass, IconClose, IconLeaf, IconSparkle, IconBriefcase, IconSave, IconArrowRight, IconLoginArrow, IconPlus, IconFilter });
